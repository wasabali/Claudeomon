...
Reference for adding new skills, items, trainers, and emblems to Cloud Quest's data layer. Use when creating new game content. Covers the registry pattern, all required fields, valid domain/tier values, and cursed technique structure.
