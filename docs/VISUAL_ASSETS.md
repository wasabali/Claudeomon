...
| `void_tiles.png` | Space / void biome (14 tiles) | `dev_null_void` | 672×48px |
| `wasteland_tiles.png` | Wasteland / ruined infrastructure biome (14 tiles) | `deprecated_azure_region` | 672×48px |

All tileset PNGs live in `assets/tiles/`. Matching `.tsj` (Tiled JSON) descriptor files live alongside them.

### Void biome tileset

`void_tiles.png` is **custom pixel art** generated by `scripts/generate-tilesets.js` — no external
asset packs. See `assets/tiles/CREDITS.md` for the authoritative tile index and licence.
...
| 12 | `void_glitch_corrupt` | Objects |
| 13 | `void_data_stream` | Objects |
...
### Wasteland biome tileset

`wasteland_tiles.png` is **custom pixel art** generated by `scripts/generate-tilesets.js` — no external
asset packs. See `assets/tiles/CREDITS.md` for the authoritative tile index and licence.
...
| 12 | `waste_dead_tree` | Objects |
| 13 | `waste_broken_sign` | Objects |
