...
| **Dockertle Treat** | ✅ | Heal 50 HP | Ivan's thank-you gift. A tasty container snack. Restores 50 HP. |
| **Spot Instance Coupon** | ✅ | Restore 100 Budget | +100 budget. 30% chance the instance gets terminated mid-use. Worth it? Probably. |
...
| **Blueprint v3 — Containers** | Alice's third design stage. Docker + K8s with limits. |
