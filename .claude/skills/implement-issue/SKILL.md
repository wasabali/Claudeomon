...
**Always run the `post-implementation` skill after completing an issue.** This is not optional — it replaces the old CI pipelines. Invoke `/post-implementation`, which will:
