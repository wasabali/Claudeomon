---
name: add-incident
description: Turn a real work problem into a Cloud Quest battle incident. Invoke with a description of the issue (e.g. /add-incident "Our pods keep OOMKilling in prod after the latest deploy").
---
